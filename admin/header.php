...
<head>
    ...
    <title>Admin Dashboard - Presensi Staf Desa Sungai Rambut</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <div class="sidebar">
        <div class="d-flex align-items-center mb-4 pb-3 border-bottom border-secondary border-opacity-25">
            <i class="bi bi-shield-check text-white fs-3 me-2"></i>
            <div>
        ...
        <ul class="nav flex-column mb-auto">
            ...
            <li class="nav-item">
                <a class="nav-link <?= ($current_page === 'jabatan.php') ? 'active' : '' ?>" href="jabatan.php">
                    <i class="bi bi-briefcase"></i> Data Jabatan
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= ($current_page === 'pegawai.php') ? 'active' : '' ?>" href="pegawai.php">
            ...
            <li class="nav-item">
                <a class="nav-link <?= ($current_page === 'import.php') ? 'active' : '' ?>" href="import.php">
                    <i class="bi bi-file-earmark-excel"></i> Import Absensi
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= ($current_page === 'presensi.php') ? 'active' : '' ?>" href="presensi.php">
            ...
            <li class="nav-item">
                <a class="nav-link <?= ($current_page === 'profil.php') ? 'active' : '' ?>" href="profil.php">
                    <i class="bi bi-person-bounding-box"></i> Profil Admin
                </a>
            </li>
        </ul>
