...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        <h4 class="fw-bold text-dark mb-1">Dashboard Kepala Desa</h4>
        <p class="text-muted mb-0">Selamat datang kembali, Bapak Kepala Desa <?= htmlspecialchars($_SESSION['nama_lengkap']) ?>.</p>
    </div>
    <div>
...
<div class="row g-4 mb-4">
    ...
    <div class="col-md-3">
        <div class="metric-card terlambat">
            <h6 class="text-muted fw-semibold mb-2">Terlambat Hari Ini</h6>
    ...
    <div class="col-md-3">
        <div class="metric-card alpha">
            <h6 class="text-muted fw-semibold mb-2">Alpha Hari Ini</h6>
